...
#let ws-p = ignore(regex-p("\\s*"))
#let number-p = map-p(int, regex-p("-?[0-9]+"))
#let identifier-p = regex-p("[A-Za-z][A-Za-z0-9_-]*")
...
}}    `.text, "json-test-2", "Big json example")
